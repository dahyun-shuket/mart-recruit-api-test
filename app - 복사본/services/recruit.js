...
module.exports = class recruitService {
    ...
    static reactList(martSeq, active, name, subject, userSeq, userOwn, regions, jobKinds, workingTypes, scrapSeq) {
        return new Promise(function(resolve, reject) {
            try {
                
                let result = recruitModel.reactList(martSeq, active, name, subject, userSeq, userOwn, regions, jobKinds, workingTypes, scrapSeq);
